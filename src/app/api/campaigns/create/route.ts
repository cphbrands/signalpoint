...
export async function POST(req: NextRequest) {
  ...
  if (!Number.isFinite(nationalNumberLength) || nationalNumberLength < 4 || nationalNumberLength > 12) {
    return NextResponse.json({ error: "INVALID_NATIONAL_NUMBER_LENGTH" }, { status: 400 });
  }
